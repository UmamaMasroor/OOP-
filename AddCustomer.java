...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    AddCustomer(String username) {
        ...
        c1 = new JComboBox<>(new String[] { "Passport", "Aadhar Card", "Rasan Card", "Pan Card" });
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            ...
            String radio = r1.isSelected() ? "Male" : r2.isSelected() ? "Female" : null;
    ...
    public static void main(String[] args) {
        ...
        AddCustomer frame = new AddCustomer(username);
